...
export default function DeanWords({ inDepartment, department, departmentData }) {

    const element = inDepartment ?
        <div className="DeanWords">
            <img src={departmentData.img} alt="DeansWords"></img>
            <h2>{departmentData.dean}</h2>
            <h4>{departmentData.deanOccupation}</h4>
            <p>{departmentData.deanWord}</p>
        </div>
        :
        <div className="DeanWords">
